...
CREATE TABLE `BUCKETING_COLS` (
  ...
  `BUCKET_COL_NAME` varchar(255) CHARACTER SET latin1 DEFAULT NULL,
...
CREATE TABLE `COLUMNS_V2` (
  ...
  `COLUMN_NAME` varchar(128) CHARACTER SET latin1 NOT NULL,
  `TYPE_NAME` varchar(4000) CHARACTER SET latin1 NOT NULL,
  `INTEGER_IDX` int(11) NOT NULL,
...
CREATE TABLE `FUNCS` (
  ...
  `CLASS_NAME` varchar(4000) CHARACTER SET latin1 DEFAULT NULL,
  `CREATE_TIME` int(11) NOT NULL,
  `DB_ID` bigint(20) DEFAULT NULL,
  `FUNC_NAME` varchar(128) CHARACTER SET latin1 DEFAULT NULL,
...
CREATE TABLE `FUNC_RU` (
  ...
  `RESOURCE_URI` varchar(4000) CHARACTER SET latin1 DEFAULT NULL,
  `INTEGER_IDX` int(11) NOT NULL,
...
CREATE TABLE `KEY_CONSTRAINTS` (
  `CONSTRAINT_NAME` varchar(255) CHARACTER SET latin1 NOT NULL,
...
CREATE TABLE `MASTER_KEYS` (
  ...
  `MASTER_KEY` varchar(767) CHARACTER SET latin1 DEFAULT NULL,
  PRIMARY KEY (`KEY_ID`)
) ENGINE=ndbcluster DEFAULT CHARSET=latin1 COLLATE=latin1_general_cs;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `PARTITION_KEY_VALS` (
  `PART_ID` bigint(20) NOT NULL,
  `PART_KEY_VAL` varchar(255) CHARACTER SET latin1 DEFAULT NULL,
  `INTEGER_IDX` int(11) NOT NULL,
...
CREATE TABLE `PART_COL_PRIVS` (
  ...
  `COLUMN_NAME` varchar(128) CHARACTER SET latin1 DEFAULT NULL,
  `CREATE_TIME` int(11) NOT NULL,
  `GRANT_OPTION` smallint(6) NOT NULL,
  `GRANTOR` varchar(128) CHARACTER SET latin1 DEFAULT NULL,
  `GRANTOR_TYPE` varchar(128) CHARACTER SET latin1 DEFAULT NULL,
...
CREATE TABLE `PART_COL_STATS` (
  ...
  `BIG_DECIMAL_HIGH_VALUE` varchar(255) CHARACTER SET latin1 DEFAULT NULL,
  `BIG_DECIMAL_LOW_VALUE` varchar(255) CHARACTER SET latin1 DEFAULT NULL,
...
CREATE TABLE `SKEWED_COL_NAMES` (
  `SD_ID` bigint(20) NOT NULL,
  `SKEWED_COL_NAME` varchar(255) CHARACTER SET latin1 DEFAULT NULL,
  `INTEGER_IDX` int(11) NOT NULL,
  PRIMARY KEY (`SD_ID`,`INTEGER_IDX`),
...
CREATE TABLE `SKEWED_STRING_LIST_VALUES` (
  `STRING_LIST_ID` bigint(20) NOT NULL,
  `STRING_LIST_VALUE` varchar(255) CHARACTER SET latin1 DEFAULT NULL,
  `INTEGER_IDX` int(11) NOT NULL,
...
CREATE TABLE `VERSION` (
  ...
  `SCHEMA_VERSION` varchar(127) CHARACTER SET latin1 NOT NULL,
  `VERSION_COMMENT` varchar(255) CHARACTER SET latin1 NOT NULL,
  PRIMARY KEY (`VER_ID`)
) ENGINE=ndbcluster DEFAULT CHARSET=latin1 COLLATE=latin1_general_cs;
