...
GetNextWriteIdRequest::GetNextWriteIdRequest(const GetNextWriteIdRequest& other884) {
  dbName = other884.dbName;
  tblName = other884.tblName;
}
GetNextWriteIdRequest& GetNextWriteIdRequest::operator=(const GetNextWriteIdRequest& other885) {
  dbName = other885.dbName;
  tblName = other885.tblName;
  return *this;
}
...
GetNextWriteIdResult::GetNextWriteIdResult(const GetNextWriteIdResult& other886) {
  writeId = other886.writeId;
}
GetNextWriteIdResult& GetNextWriteIdResult::operator=(const GetNextWriteIdResult& other887) {
  writeId = other887.writeId;
  return *this;
}
...
FinalizeWriteIdRequest::FinalizeWriteIdRequest(const FinalizeWriteIdRequest& other888) {
  dbName = other888.dbName;
  tblName = other888.tblName;
  writeId = other888.writeId;
  commit = other888.commit;
}
FinalizeWriteIdRequest& FinalizeWriteIdRequest::operator=(const FinalizeWriteIdRequest& other889) {
  dbName = other889.dbName;
  tblName = other889.tblName;
  writeId = other889.writeId;
  commit = other889.commit;
  return *this;
}
...
FinalizeWriteIdResult::FinalizeWriteIdResult(const FinalizeWriteIdResult& other890) {
  (void) other890;
}
FinalizeWriteIdResult& FinalizeWriteIdResult::operator=(const FinalizeWriteIdResult& other891) {
  (void) other891;
  return *this;
}
...
HeartbeatWriteIdRequest::HeartbeatWriteIdRequest(const HeartbeatWriteIdRequest& other892) {
  dbName = other892.dbName;
  tblName = other892.tblName;
  writeId = other892.writeId;
}
HeartbeatWriteIdRequest& HeartbeatWriteIdRequest::operator=(const HeartbeatWriteIdRequest& other893) {
  dbName = other893.dbName;
  tblName = other893.tblName;
  writeId = other893.writeId;
  return *this;
}
...
HeartbeatWriteIdResult::HeartbeatWriteIdResult(const HeartbeatWriteIdResult& other894) {
  (void) other894;
}
HeartbeatWriteIdResult& HeartbeatWriteIdResult::operator=(const HeartbeatWriteIdResult& other895) {
  (void) other895;
  return *this;
}
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->ids.resize(_size896);
            uint32_t _i900;
            for (_i900 = 0; _i900 < _size896; ++_i900)
            {
              xfer += iprot->readI64(this->ids[_i900]);
            }
            xfer += iprot->readListEnd();
          }
...
uint32_t GetValidWriteIdsResult::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  if (this->__isset.ids) {
    xfer += oprot->writeFieldBegin("ids", ::apache::thrift::protocol::T_LIST, 4);
    {
      ...
      std::vector<int64_t> ::const_iterator _iter901;
      for (_iter901 = this->ids.begin(); _iter901 != this->ids.end(); ++_iter901)
      {
        xfer += oprot->writeI64((*_iter901));
      }
      xfer += oprot->writeListEnd();
    }
    xfer += oprot->writeFieldEnd();
...
GetValidWriteIdsResult::GetValidWriteIdsResult(const GetValidWriteIdsResult& other902) {
  lowWatermarkId = other902.lowWatermarkId;
  highWatermarkId = other902.highWatermarkId;
  areIdsValid = other902.areIdsValid;
  ids = other902.ids;
  __isset = other902.__isset;
}
GetValidWriteIdsResult& GetValidWriteIdsResult::operator=(const GetValidWriteIdsResult& other903) {
  lowWatermarkId = other903.lowWatermarkId;
  highWatermarkId = other903.highWatermarkId;
  areIdsValid = other903.areIdsValid;
  ids = other903.ids;
