            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.triggers = new ArrayList<WMTrigger>(_list912.size);
                WMTrigger _elem913;
                for (int _i914 = 0; _i914 < _list912.size; ++_i914)
                {
                  _elem913 = new WMTrigger();
                  _elem913.read(iprot);
                  struct.triggers.add(_elem913);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.triggers != null) {
        if (struct.isSetTriggers()) {
          oprot.writeFieldBegin(TRIGGERS_FIELD_DESC);
          {
            ...
            for (WMTrigger _iter915 : struct.triggers)
            {
      ...
      if (struct.isSetTriggers()) {
        {
          ...
          for (WMTrigger _iter916 : struct.triggers)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.triggers = new ArrayList<WMTrigger>(_list917.size);
          WMTrigger _elem918;
          for (int _i919 = 0; _i919 < _list917.size; ++_i919)
          {
            _elem918 = new WMTrigger();
            _elem918.read(iprot);
            struct.triggers.add(_elem918);
          }
        }
        struct.setTriggersIsSet(true);
      }
