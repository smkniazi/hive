...
@org.apache.hadoop.classification.InterfaceAudience.Public @org.apache.hadoop.classification.InterfaceStability.Stable public class GetValidWriteIdsResult implements org.apache.thrift.TBase<GetValidWriteIdsResult, GetValidWriteIdsResult._Fields>, java.io.Serializable, Cloneable, Comparable<GetValidWriteIdsResult> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.ids = new ArrayList<Long>(_list808.size);
                long _elem809;
                for (int _i810 = 0; _i810 < _list808.size; ++_i810)
                {
                  _elem809 = iprot.readI64();
                  struct.ids.add(_elem809);
                }
                iprot.readListEnd();
              }
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.ids = new ArrayList<Long>(_list813.size);
          long _elem814;
          for (int _i815 = 0; _i815 < _list813.size; ++_i815)
          {
            _elem814 = iprot.readI64();
            struct.ids.add(_elem814);
          }
        }
        struct.setIdsIsSet(true);
      }
