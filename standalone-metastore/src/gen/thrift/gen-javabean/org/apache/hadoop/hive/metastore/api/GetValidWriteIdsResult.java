            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.ids = new ArrayList<Long>(_list776.size);
                long _elem777;
                for (int _i778 = 0; _i778 < _list776.size; ++_i778)
                {
                  _elem777 = iprot.readI64();
                  struct.ids.add(_elem777);
                }
                iprot.readListEnd();
              }
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.ids = new ArrayList<Long>(_list781.size);
          long _elem782;
          for (int _i783 = 0; _i783 < _list781.size; ++_i783)
          {
            _elem782 = iprot.readI64();
            struct.ids.add(_elem782);
          }
        }
        struct.setIdsIsSet(true);
      }
