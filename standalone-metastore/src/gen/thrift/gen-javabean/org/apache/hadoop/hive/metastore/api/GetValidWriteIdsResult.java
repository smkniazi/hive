            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.ids = new ArrayList<Long>(_list784.size);
                long _elem785;
                for (int _i786 = 0; _i786 < _list784.size; ++_i786)
                {
                  _elem785 = iprot.readI64();
                  struct.ids.add(_elem785);
                }
                iprot.readListEnd();
              }
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.ids = new ArrayList<Long>(_list789.size);
          long _elem790;
          for (int _i791 = 0; _i791 < _list789.size; ++_i791)
          {
            _elem790 = iprot.readI64();
            struct.ids.add(_elem790);
          }
        }
        struct.setIdsIsSet(true);
      }
