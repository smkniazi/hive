...
class GetValidWriteIdsResult:
  ...
  def write(self, oprot):
    ...
    if self.ids is not None:
      ...
      for iter644 in self.ids:
        oprot.writeI64(iter644)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
    oprot.writeStructEnd()
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i649 in xrange(_size645):
            _elem650 = Function()
            _elem650.read(iprot)
            self.functions.append(_elem650)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
...
class Materialization:
  ...
  def write(self, oprot):
    ...
    if self.tablesUsed is not None:
      ...
      for iter679 in self.tablesUsed:
...
class WMFullResourcePlan:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i702 in xrange(_size698):
            _elem703 = WMPoolTrigger()
            _elem703.read(iprot)
            self.poolTriggers.append(_elem703)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.poolTriggers is not None:
      ...
      for iter707 in self.poolTriggers:
        iter707.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
...
class WMGetAllResourcePlanResponse:
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i712 in xrange(_size708):
            _elem713 = WMResourcePlan()
            _elem713.read(iprot)
            self.resourcePlans.append(_elem713)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.resourcePlans is not None:
      ...
      for iter714 in self.resourcePlans:
        iter714.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
