...
INSERT INTO `CTLGS` VALUES (1, 'hive', 'Default catalog for Hive', null);
...
ALTER TABLE `TBLS` ADD COLUMN `OWNER_TYPE` VARCHAR(10) CHARACTER SET latin1 COLLATE latin1_general_cs DEFAULT NULL;
