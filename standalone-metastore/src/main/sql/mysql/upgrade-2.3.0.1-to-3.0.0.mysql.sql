...
ALTER TABLE `SERDES` ADD COLUMN `DESCRIPTION` VARCHAR(2000);
ALTER TABLE `SERDES` ADD COLUMN `SERIALIZER_CLASS` VARCHAR(2000);
ALTER TABLE `SERDES` ADD COLUMN `DESERIALIZER_CLASS` VARCHAR(2000);
...
CREATE TABLE IF NOT EXISTS `MV_CREATION_METADATA` (
  ...
  `CAT_NAME` varchar(256) CHARACTER SET latin1 COLLATE latin_general_cs NOT NULL,
  `DB_NAME` varchar(128) CHARACTER SET latin1 COLLATE latin_general_cs NOT NULL,
  `TBL_NAME` varchar(256) CHARACTER SET latin1 COLLATE latin_general_cs NOT NULL,
...
ALTER TABLE `TBLS` ADD COLUMN `OWNER_TYPE` VARCHAR(10) CHARACTER SET latin1 COLLATE latin_general_cs DEFAULT NULL;

-- Fix collate  for all columns to be latin1_general_cs
