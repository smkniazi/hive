...
CREATE TABLE IF NOT EXISTS `DBS` (
  ...
  CONSTRAINT `DB_SD_FK` FOREIGN KEY (`SD_ID`) REFERENCES `SDS` (`SD_ID`) ON DELETE CASCADE ON UPDATE RESTRICT
  CONSTRAINT `CTLG_FK` FOREIGN KEY (`CTLG_NAME`) REFERENCES `NAME` (`CTLGS`) ON DELETE CASCADE ON UPDATE RESTRICT
) ENGINE=NDBCLUSTER DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- -----------------------------------------------------------------
INSERT INTO VERSION (VER_ID, SCHEMA_VERSION, VERSION_COMMENT) VALUES (1, '3.0.0.1', 'Hive release version 3.0.0.1');
